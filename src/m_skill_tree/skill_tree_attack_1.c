...
void init_stree_node02(s_appdata *adata, s_skill_tree *skill0)
{
    ...
    add_skill_node(adata, skill0, node_0_2, 2);
    ...
    set_skill_node_level(adata, skill0, node_0_2, 1);
}
...
void init_stree_node03(s_appdata *adata, s_skill_tree *skill0)
{
    ...
    add_skill_node(adata, skill0, node_0_3, 3);
    ...
    set_skill_node_level(adata, skill0, node_0_3, 2);
}
...
void init_stree_node04(s_appdata *adata, s_skill_tree *skill0)
{
    ...
    add_skill_node(adata, skill0, node_0_4, 4);
    ...
    set_skill_node_level(adata, skill0, node_0_4, 3);
}
...
void init_stree_node05(s_appdata *adata, s_skill_tree *skill0)
{
    ...
    add_skill_node(adata, skill0, node_0_5, 5);
    ...
    set_skill_node_level(adata, skill0, node_0_5, 4);
}
...
void init_stree_node06(s_appdata *adata, s_skill_tree *skill0)
{
    ...
    add_skill_node(adata, skill0, node_0_6, 6);
    ...
    set_skill_node_level(adata, skill0, node_0_6, 5);
}
