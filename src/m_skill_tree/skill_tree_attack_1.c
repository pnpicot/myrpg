...
void init_stree_node02(s_appdata *adata, s_skill_tree *skill0)
{
    ...
    set_skill_node_icon(adata, skill0, node_0_2, get_texture(adata, "tree_cube"));
...
void init_stree_node03(s_appdata *adata, s_skill_tree *skill0)
{
    ...
    set_skill_node_icon(adata, skill0, node_0_3, get_texture(adata, "tree_cube"));
...
void init_stree_node04(s_appdata *adata, s_skill_tree *skill0)
{
    ...
    set_skill_node_icon(adata, skill0, node_0_4, get_texture(adata, "tree_cube"));
...
void init_stree_node05(s_appdata *adata, s_skill_tree *skill0)
{
    ...
    set_skill_node_icon(adata, skill0, node_0_5, get_texture(adata, "tree_cube"));
...
void init_stree_node06(s_appdata *adata, s_skill_tree *skill0)
{
    ...
    set_skill_node_icon(adata, skill0, node_0_6, get_texture(adata, "tree_cube"));
