...
void init_stree_node01(s_appdata *adata, s_skill_tree *skill0)
{
    ...
    set_skill_node_icon(adata, skill0, node_0_1, get_texture(adata, "tcube"));
...
void init_stree_node11(s_appdata *adata, s_skill_tree *skill1)
{
    ...
    set_skill_node_icon(adata, skill1, node_1_1, get_texture(adata, "tcube"));
...
void init_stree_node21(s_appdata *adata, s_skill_tree *skill2)
{
    ...
    set_skill_node_icon(adata, skill2, node_2_1, get_texture(adata, "tcube"));
...
void init_stree_node31(s_appdata *adata, s_skill_tree *skill3)
{
    ...
    set_skill_node_icon(adata, skill3, node_3_1, get_texture(adata, "tcube"));
