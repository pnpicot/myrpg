...
void init_stree_node12(s_appdata *adata, s_skill_tree *skill1)
{
    ...
    set_skill_node_icon(adata, skill1, node_1_2, get_texture(adata, "tree_cube"));
...
void init_stree_node13(s_appdata *adata, s_skill_tree *skill1)
{
    ...
    set_skill_node_icon(adata, skill1, node_1_3, get_texture(adata, "tree_cube"));
...
void init_stree_node14(s_appdata *adata, s_skill_tree *skill1)
{
    ...
    set_skill_node_icon(adata, skill1, node_1_4, get_texture(adata, "tree_cube"));
...
void init_stree_node15(s_appdata *adata, s_skill_tree *skill1)
{
    ...
    set_skill_node_icon(adata, skill1, node_1_5, get_texture(adata, "tree_cube"));
...
void init_stree_node16(s_appdata *adata, s_skill_tree *skill1)
{
    ...
    set_skill_node_icon(adata, skill1, node_1_6, get_texture(adata, "tree_cube"));
