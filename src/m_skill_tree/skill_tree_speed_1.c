...
void init_stree_node22(s_appdata *adata, s_skill_tree *skill2)
{
    ...
    set_skill_node_icon(adata, skill2, node_2_2, get_texture(adata, "tree_cube"));
...
void init_stree_node23(s_appdata *adata, s_skill_tree *skill2)
{
    ...
    set_skill_node_icon(adata, skill2, node_2_3, get_texture(adata, "tree_cube"));
...
void init_stree_node24(s_appdata *adata, s_skill_tree *skill2)
{
    ...
    set_skill_node_icon(adata, skill2, node_2_4, get_texture(adata, "tree_cube"));
...
void init_stree_node25(s_appdata *adata, s_skill_tree *skill2)
{
    ...
    set_skill_node_icon(adata, skill2, node_2_5, get_texture(adata, "tree_cube"));
...
void init_stree_node26(s_appdata *adata, s_skill_tree *skill2)
{
    ...
    set_skill_node_icon(adata, skill2, node_2_6, get_texture(adata, "tree_cube"));
